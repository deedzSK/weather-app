...
export function SearchBar({ onSearch }) {
    ...
    return (
        <div className="w-full xl:w-auto h-[55vh] xl:h-auto">
            {/* Десктоп версия */}
            ...
            <div className="xl:hidden flex flex-col h-full">
                ...
                <div className="pt-26.75 w-full h-full flex flex-col items-center bg-black/30 backdrop-blur-sm">
                    <div className="flex items-center w-75 border-b border-white pb-2">
                        <input
                            className="outline-none w-full"
                            type="text"
                            placeholder="Search Location..."
